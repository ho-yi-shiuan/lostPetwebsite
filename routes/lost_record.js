...
app.get('/', async function(req, res){
	...
	var query_array = [];
	var condition_array = [];
	if(typeof(req.query.lost_status) == "object"){
		let lost_status_query = " lost_status in (?)";
		condition_array.push(req.query.lost_status);
		select_array.push(lost_status_query);
	}else if(typeof(req.query.lost_status) == "string"){
		let lost_status_query = " lost_status in (?)";
		condition_array.push([req.query.lost_status]);
		select_array.push(lost_status_query);
	}
	...
	if(typeof(req.query.select_gender) == "object"){
		let gender_query = " (gender is null or gender in (?))";
